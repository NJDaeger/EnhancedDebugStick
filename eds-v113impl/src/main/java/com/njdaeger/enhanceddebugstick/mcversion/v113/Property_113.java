...
public class Property_113<D extends BlockData, V> extends AbstractProperty<D, V> {
    
    /**
     * Age property
     */
    static IProperty<Ageable, Integer> AGE = new Property_113<>("Age", Ageable.class, Integer.class, (age) -> {
     ...
     * Power property
     */
    static IProperty<AnaloguePowerable, Integer> POWER = new Property_113<>("Power", AnaloguePowerable.class, Integer.class, (power) -> {
     ...
     * Attached property
     */
    static IProperty<Attachable, Boolean> ATTACHED = new Property_113<>("Attached", Attachable.class, Boolean.class, (attachable) -> {
     ...
     * Half property
     */
    static IProperty<Bisected, Bisected.Half> HALF = new Property_113<>("Half", Bisected.class, Bisected.Half.class, (bisected) -> {
     ...
     * Facing property
     */
    static IProperty<Directional, BlockFace> FACING = new Property_113<>("Facing", Directional.class, BlockFace.class, (directional) -> {
     ...
     * Lit property
     */
    static IProperty<Lightable, Boolean> LIT = new Property_113<>("Lit", Lightable.class, Boolean.class, (lit) -> {
     ...
     * Open property
     */
    static IProperty<Openable, Boolean> OPEN = new Property_113<>("Open", Openable.class, Boolean.class, (open) -> {
     ...
     * Axis property
     */
    static IProperty<Orientable, Axis> AXIS = new Property_113<>("Axis", Orientable.class, Axis.class, (axis) -> {
     ...
     * Powered property
     */
    static IProperty<Powerable, Boolean> POWERED = new Property_113<>("Powered", Powerable.class, Boolean.class, (powered) -> {
     ...
     * Rotation property
     */
    static IProperty<Rotatable, BlockFace> ROTATION = new Property_113<>("Rotation", Rotatable.class, BlockFace.class, (rotation) -> {
     ...
     * Snowy property
     */
    static IProperty<Snowable, Boolean> SNOWY = new Property_113<>("Snowy", Snowable.class, Boolean.class, (snowable) -> {
     ...
     */
    static IProperty<Waterlogged, Boolean> WATERLOGGED = new Property_113<>("Waterlogged", Waterlogged.class, Boolean.class, (waterlogged) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_EAST = new Property_113<>("East", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_NORTH = new Property_113<>("North", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_SOUTH = new Property_113<>("South", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_WEST = new Property_113<>("West", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<DaylightDetector, Boolean> DETECTOR_INVERTED = new Property_113<>("Inverted", DaylightDetector.class, Boolean.class, (detector) -> {
     ...
     */
    static IProperty<Tripwire, Boolean> TRIPWIRE_DISARMED = new Property_113<>("Disarmed", Tripwire.class, Boolean.class, (tripwire) -> {
     ...
     * Hinge property. (Door)
     */
    static IProperty<Door, Door.Hinge> DOOR_HINGE = new Property_113<>("Hinge", Door.class, Door.Hinge.class, (door) -> {
     ...
     */
    static IProperty<Stairs, Stairs.Shape> STAIR_SHAPE = new Property_113<>("Shape", Stairs.class, Stairs.Shape.class, (stairs) -> {
     ...
     * Part property. (Bed)
     */
    static IProperty<Bed, Bed.Part> BED_PART = new Property_113<>("Part", Bed.class, Bed.Part.class, (bed) -> {
     ...
     * Type property. (Chest)
     */
    static IProperty<Chest, Chest.Type> CHEST_TYPE = new Property_113<>("Type", Chest.class, Chest.Type.class, (chest) -> {
     ...
     */
    static IProperty<CommandBlock, Boolean> COMMAND_CONDITIONAL = new Property_113<>("Conditional", CommandBlock.class, Boolean.class, (commandBlock) -> {
     ...
     */
    static IProperty<Comparator, Comparator.Mode> COMPARATOR_MODE = new Property_113<>("Mode", Comparator.class, Comparator.Mode.class, (comparator) -> {
     ...
     */
    static IProperty<Dispenser, Boolean> DISPENSER_TRIGGERED = new Property_113<>("Triggered", Dispenser.class, Boolean.class, (dispenser) -> {
     ...
     */
    static IProperty<EndPortalFrame, Boolean> END_PORTAL_EYE = new Property_113<>("Eye", EndPortalFrame.class, Boolean.class, (frame) -> {
     ...
     */
    static IProperty<Gate, Boolean> GATE_IN_WALL = new Property_113<>("In wall", Gate.class, Boolean.class, (gate) -> {
     ...
     */
    static IProperty<Hopper, Boolean> HOPPER_ENABLED = new Property_113<>("Enabled", Hopper.class, Boolean.class, (hopper) -> {
     ...
     */
    static IProperty<Piston, Boolean> PISTON_EXTENDED = new Property_113<>("Extended", Piston.class, Boolean.class, (piston) -> {
     ...
     */
    static IProperty<PistonHead, Boolean> PISTON_HEAD_SHORT = new Property_113<>("Short", PistonHead.class, Boolean.class, (pistonHead) -> {
     ...
     */
    static IProperty<Repeater, Integer> REPEATER_DELAY = new Property_113<>("Delay", Repeater.class, Integer.class, (repeater) -> {
     ...
     */
    static IProperty<Repeater, Boolean> REPEATER_LOCKED = new Property_113<>("Locked", Repeater.class, Boolean.class, (repeater) -> {
     ...
     */
    static IProperty<Switch, Switch.Face> SWITCH_FACE = new Property_113<>("Face", Switch.class, Switch.Face.class, (swtch) -> {
     ...
     */
    static IProperty<TechnicalPiston, TechnicalPiston.Type> TECHNICAL_PISTON_TYPE = new Property_113<>("Type", TechnicalPiston.class, TechnicalPiston.Type.class, (technicalPiston) -> {
     ...
     * North property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH = new Property_113<>("North", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * East property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST = new Property_113<>("East", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * South property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH = new Property_113<>("South", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * West property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST = new Property_113<>("West", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Up property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_UP = new Property_113<>("Up", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Down property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_DOWN = new Property_113<>("Down", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Northeast property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_EAST = new Property_113<>("Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Northwest property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_WEST = new Property_113<>("Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Southeast property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_EAST = new Property_113<>("Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Southwest property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_WEST = new Property_113<>("Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST_NORTH_WEST = new Property_113<>("West Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_NORTH_WEST = new Property_113<>("North Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_NORTH_EAST = new Property_113<>("North Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST_NORTH_EAST = new Property_113<>("East Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST_SOUTH_EAST = new Property_113<>("East Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_SOUTH_EAST = new Property_113<>("South Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_SOUTH_WEST = new Property_113<>("South Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST_SOUTH_WEST = new Property_113<>("West Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Self property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SELF = new Property_113<>("Self", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<NoteBlock, Instrument> NOTEBLOCK_INSTRUMENT = new Property_113<>("Instrument", NoteBlock.class, Instrument.class, (noteblock) -> {
     ...
     */
    static IProperty<NoteBlock, Note> NOTEBLOCK_NOTE = new Property_113<>("Note", NoteBlock.class, Note.class, (noteblock) -> {
     ...
     * Shape property. (Rail)
     */
    static IProperty<Rail, Rail.Shape> RAIL_SHAPE = new Property_113<>("Shape", Rail.class, Rail.Shape.class, (rail) -> {
     ...
     */
    static IProperty<SeaPickle, Integer> SEA_PICKLE_PICKLES = new Property_113<>("Pickles", SeaPickle.class, Integer.class, (pickle) -> {
     ...
     * Type property. (Slab)
     */
    static IProperty<Slab, Slab.Type> SLAB_TYPE = new Property_113<>("Type", Slab.class, Slab.Type.class, (slab) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_1 = new Property_113<>("Bottle 0", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_2 = new Property_113<>("Bottle 1", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_3 = new Property_113<>("Bottle 2", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BubbleColumn, Boolean> BUBBLE_COLUMN_DRAG = new Property_113<>("Drag", BubbleColumn.class, Boolean.class, (column) -> {
     ...
     * Bites property. (Cake)
     */
    static IProperty<Cake, Integer> CAKE_BITES = new Property_113<>("Bites", Cake.class, Integer.class, (cake) -> {
     ...
     */
    static IProperty<Farmland, Integer> FARMLAND_MOISTURE = new Property_113<>("Moisture", Farmland.class, Integer.class, (farmland) -> {
     ...
     */
    static IProperty<Leaves, Integer> LEAVES_DISTANCE = new Property_113<>("Distance", Leaves.class, Integer.class, (leaves) -> {
     ...
     */
    static IProperty<Leaves, Boolean> LEAVES_PERSISTENT = new Property_113<>("Persistent", Leaves.class, Boolean.class, (leaves) -> {
     ...
     */
    static IProperty<Sapling, Integer> SAPLING_STAGE = new Property_113<>("Stage", Sapling.class, Integer.class, (sapling) -> {
     ...
     */
    static IProperty<Snow, Integer> SNOW_LAYERS = new Property_113<>("Layers", Snow.class, Integer.class, (snow) -> {
     ...
     */
    static IProperty<StructureBlock, StructureBlock.Mode> STRUCTURE_BLOCK_MODE = new Property_113<>("Mode", StructureBlock.class, StructureBlock.Mode.class, (structureBlock) -> {
     ...
     */
    static IProperty<TNT, Boolean> TNT_UNSTABLE = new Property_113<>("Unstable", TNT.class, Boolean.class, (tnt) -> {
     ...
     */
    static IProperty<TurtleEgg, Integer> TURTLE_EGG_HATCH = new Property_113<>("Hatch", TurtleEgg.class, Integer.class, (egg) -> {
     ...
     */
    static IProperty<TurtleEgg, Integer> TURTLE_EGG_EGGS = new Property_113<>("Eggs", TurtleEgg.class, Integer.class, (egg) -> {
    ...
    public static void registerProperties() {
        ...
        registered = true;
        for (Field field : Property_113.class.getDeclaredFields()) {
    ...
    private Property_113(String niceName, Class<D> dataType, Class<V> valueType, Function<D, D> next, Function<D, V> current, BiFunction<D, V, D> set) {
