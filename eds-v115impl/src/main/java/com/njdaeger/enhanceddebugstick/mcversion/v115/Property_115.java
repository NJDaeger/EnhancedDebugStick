...
public class Property_115<D extends BlockData, V> extends AbstractProperty<D, V> {
    
    /**
     * Age property
     */
    static IProperty<Ageable, Integer> AGE = new Property_115<>("Age", Ageable.class, Integer.class, (age) -> {
     ...
     * Power property
     */
    static IProperty<AnaloguePowerable, Integer> POWER = new Property_115<>("Power", AnaloguePowerable.class, Integer.class, (power) -> {
     ...
     * Attached property
     */
    static IProperty<Attachable, Boolean> ATTACHED = new Property_115<>("Attached", Attachable.class, Boolean.class, (attachable) -> {
     ...
     * Half property
     */
    static IProperty<Bisected, Bisected.Half> HALF = new Property_115<>("Half", Bisected.class, Bisected.Half.class, (bisected) -> {
     ...
     * Facing property
     */
    static IProperty<Directional, BlockFace> FACING = new Property_115<>("Facing", Directional.class, BlockFace.class, (directional) -> {
     ...
     * Level property
     */
    static IProperty<Levelled, Integer> LEVEL = new Property_115<>("Level", Levelled.class, Integer.class, (level) -> {
     ...
     * Lit property
     */
    static IProperty<Lightable, Boolean> LIT = new Property_115<>("Lit", Lightable.class, Boolean.class, (lit) -> {
     ...
     * Open property
     */
    static IProperty<Openable, Boolean> OPEN = new Property_115<>("Open", Openable.class, Boolean.class, (open) -> {
     ...
     * Axis property
     */
    static IProperty<Orientable, Axis> AXIS = new Property_115<>("Axis", Orientable.class, Axis.class, (axis) -> {
     ...
     * Powered property
     */
    static IProperty<Powerable, Boolean> POWERED = new Property_115<>("Powered", Powerable.class, Boolean.class, (powered) -> {
     ...
     * Rotation property
     */
    static IProperty<Rotatable, BlockFace> ROTATION = new Property_115<>("Rotation", Rotatable.class, BlockFace.class, (rotation) -> {
     ...
     * Snowy property
     */
    static IProperty<Snowable, Boolean> SNOWY = new Property_115<>("Snowy", Snowable.class, Boolean.class, (snowable) -> {
     ...
     */
    static IProperty<Waterlogged, Boolean> WATERLOGGED = new Property_115<>("Waterlogged", Waterlogged.class, Boolean.class, (waterlogged) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_EAST = new Property_115<>("East", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_NORTH = new Property_115<>("North", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_SOUTH = new Property_115<>("South", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_WEST = new Property_115<>("West", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<DaylightDetector, Boolean> DETECTOR_INVERTED = new Property_115<>("Inverted", DaylightDetector.class, Boolean.class, (detector) -> {
     ...
     */
    static IProperty<Tripwire, Boolean> TRIPWIRE_DISARMED = new Property_115<>("Disarmed", Tripwire.class, Boolean.class, (tripwire) -> {
     ...
     * Hinge property. (Door)
     */
    static IProperty<Door, Door.Hinge> DOOR_HINGE = new Property_115<>("Hinge", Door.class, Door.Hinge.class, (door) -> {
     ...
     */
    static IProperty<Stairs, Stairs.Shape> STAIR_SHAPE = new Property_115<>("Shape", Stairs.class, Stairs.Shape.class, (stairs) -> {
     ...
     * Part property. (Bed)
     */
    static IProperty<Bed, Bed.Part> BED_PART = new Property_115<>("Part", Bed.class, Bed.Part.class, (bed) -> {
     ...
     * Type property. (Chest)
     */
    static IProperty<Chest, Chest.Type> CHEST_TYPE = new Property_115<>("Type", Chest.class, Chest.Type.class, (chest) -> {
     ...
     */
    static IProperty<CommandBlock, Boolean> COMMAND_CONDITIONAL = new Property_115<>("Conditional", CommandBlock.class, Boolean.class, (commandBlock) -> {
     ...
     */
    static IProperty<Comparator, Comparator.Mode> COMPARATOR_MODE = new Property_115<>("Mode", Comparator.class, Comparator.Mode.class, (comparator) -> {
     ...
     */
    static IProperty<Dispenser, Boolean> DISPENSER_TRIGGERED = new Property_115<>("Triggered", Dispenser.class, Boolean.class, (dispenser) -> {
     ...
     */
    static IProperty<EndPortalFrame, Boolean> END_PORTAL_EYE = new Property_115<>("Eye", EndPortalFrame.class, Boolean.class, (frame) -> {
     ...
     */
    static IProperty<Gate, Boolean> GATE_IN_WALL = new Property_115<>("In wall", Gate.class, Boolean.class, (gate) -> {
     ...
     */
    static IProperty<Hopper, Boolean> HOPPER_ENABLED = new Property_115<>("Enabled", Hopper.class, Boolean.class, (hopper) -> {
     ...
     */
    static IProperty<Piston, Boolean> PISTON_EXTENDED = new Property_115<>("Extended", Piston.class, Boolean.class, (piston) -> {
     ...
     */
    static IProperty<PistonHead, Boolean> PISTON_HEAD_SHORT = new Property_115<>("Short", PistonHead.class, Boolean.class, (pistonHead) -> {
     ...
     */
    static IProperty<Repeater, Integer> REPEATER_DELAY = new Property_115<>("Delay", Repeater.class, Integer.class, (repeater) -> {
     ...
     */
    static IProperty<Repeater, Boolean> REPEATER_LOCKED = new Property_115<>("Locked", Repeater.class, Boolean.class, (repeater) -> {
     ...
     */
    static IProperty<TechnicalPiston, TechnicalPiston.Type> TECHNICAL_PISTON_TYPE = new Property_115<>("Type", TechnicalPiston.class, TechnicalPiston.Type.class, (technicalPiston) -> {
     ...
     * North property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH = new Property_115<>("North", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * East property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST = new Property_115<>("East", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * South property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH = new Property_115<>("South", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * West property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST = new Property_115<>("West", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Up property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_UP = new Property_115<>("Up", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Down property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_DOWN = new Property_115<>("Down", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Northeast property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_EAST = new Property_115<>("Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Northwest property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_WEST = new Property_115<>("Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Southeast property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_EAST = new Property_115<>("Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Southwest property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_WEST = new Property_115<>("Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST_NORTH_WEST = new Property_115<>("West Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_NORTH_WEST = new Property_115<>("North Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_NORTH_EAST = new Property_115<>("North Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST_NORTH_EAST = new Property_115<>("East Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST_SOUTH_EAST = new Property_115<>("East Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_SOUTH_EAST = new Property_115<>("South Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_SOUTH_WEST = new Property_115<>("South Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST_SOUTH_WEST = new Property_115<>("West Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Self property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SELF = new Property_115<>("Self", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<NoteBlock, Instrument> NOTEBLOCK_INSTRUMENT = new Property_115<>("Instrument", NoteBlock.class, Instrument.class, (noteblock) -> {
     ...
     */
    static IProperty<NoteBlock, Note> NOTEBLOCK_NOTE = new Property_115<>("Note", NoteBlock.class, Note.class, (noteblock) -> {
     ...
     * Shape property. (Rail)
     */
    static IProperty<Rail, Rail.Shape> RAIL_SHAPE = new Property_115<>("Shape", Rail.class, Rail.Shape.class, (rail) -> {
     ...
     */
    static IProperty<SeaPickle, Integer> SEA_PICKLE_PICKLES = new Property_115<>("Pickles", SeaPickle.class, Integer.class, (pickle) -> {
     ...
     * Type property. (Slab)
     */
    static IProperty<Slab, Slab.Type> SLAB_TYPE = new Property_115<>("Type", Slab.class, Slab.Type.class, (slab) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_1 = new Property_115<>("Bottle 0", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_2 = new Property_115<>("Bottle 1", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_3 = new Property_115<>("Bottle 2", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BubbleColumn, Boolean> BUBBLE_COLUMN_DRAG = new Property_115<>("Drag", BubbleColumn.class, Boolean.class, (column) -> {
     ...
     * Bites property. (Cake)
     */
    static IProperty<Cake, Integer> CAKE_BITES = new Property_115<>("Bites", Cake.class, Integer.class, (cake) -> {
     ...
     */
    static IProperty<Farmland, Integer> FARMLAND_MOISTURE = new Property_115<>("Moisture", Farmland.class, Integer.class, (farmland) -> {
     ...
     */
    static IProperty<Leaves, Integer> LEAVES_DISTANCE = new Property_115<>("Distance", Leaves.class, Integer.class, (leaves) -> {
     ...
     */
    static IProperty<Leaves, Boolean> LEAVES_PERSISTENT = new Property_115<>("Persistent", Leaves.class, Boolean.class, (leaves) -> {
     ...
     */
    static IProperty<Sapling, Integer> SAPLING_STAGE = new Property_115<>("Stage", Sapling.class, Integer.class, (sapling) -> {
     ...
     */
    static IProperty<Snow, Integer> SNOW_LAYERS = new Property_115<>("Layers", Snow.class, Integer.class, (snow) -> {
     ...
     */
    static IProperty<StructureBlock, StructureBlock.Mode> STRUCTURE_BLOCK_MODE = new Property_115<>("Mode", StructureBlock.class, StructureBlock.Mode.class, (structureBlock) -> {
     ...
     */
    static IProperty<TNT, Boolean> TNT_UNSTABLE = new Property_115<>("Unstable", TNT.class, Boolean.class, (tnt) -> {
     ...
     */
    static IProperty<TurtleEgg, Integer> TURTLE_EGG_HATCH = new Property_115<>("Hatch", TurtleEgg.class, Integer.class, (egg) -> {
     ...
     */
    static IProperty<TurtleEgg, Integer> TURTLE_EGG_EGGS = new Property_115<>("Eggs", TurtleEgg.class, Integer.class, (egg) -> {
    ...
    static IProperty<Lantern, Boolean> LANTERN_HANGING = new Property_115<>("Hanging", Lantern.class, Boolean.class, (lantern) -> {
    ...
    static IProperty<Bamboo, Bamboo.Leaves> BAMBOO_LEAVES = new Property_115<>("Leaves", Bamboo.class, Bamboo.Leaves.class, (bamboo) -> {
    ...
    static IProperty<Bell, Bell.Attachment> BELL_ATTACHMENT = new Property_115<>("Attachment", Bell.class, Bell.Attachment.class, (bell) -> {
    ...
    static IProperty<Campfire, Boolean> CAMPFIRE_SIGNAL_FIRE = new Property_115<>("Signal Fire", Campfire.class, Boolean.class, (campfire) -> {
    ...
    static IProperty<Scaffolding, Boolean> SCAFFOLDING_IS_BOTTOM = new Property_115<>("Bottom", Scaffolding.class, Boolean.class, (scaffolding) -> {
    ...
    static IProperty<Scaffolding, Integer> SCAFFOLDING_DISTANCE = new Property_115<>("Distance", Scaffolding.class, Integer.class, (scaffolding) -> {
    ...
    static IProperty<Beehive, Integer> HONEY_LEVEL = new Property_115<>("Honey Level", Beehive.class, Integer.class, (beehive) -> {
    ...
    static IProperty<FaceAttachable, FaceAttachable.AttachedFace> FACE_ATTACHABLE = new Property_115<>("Face", FaceAttachable.class, FaceAttachable.AttachedFace.class, (attachable) -> {
    ...
    private Property_115(String niceName, Class<D> dataType, Class<V> valueType, Function<D, D> next, Function<D, V> current, BiFunction<D, V, D> set) {
