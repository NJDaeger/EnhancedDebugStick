package com.njdaeger.enhanceddebugstick.mcversion.v119;
...
public class Property_119<D extends BlockData, V> extends AbstractProperty<D, V> {
    
    /**
     * Age property
     */
    static IProperty<Ageable, Integer> AGE = new Property_119<>("Age", Ageable.class, Integer.class, (age) -> {
     ...
     * Power property
     */
    static IProperty<AnaloguePowerable, Integer> POWER = new Property_119<>("Power", AnaloguePowerable.class, Integer.class, (power) -> {
     ...
     * Attached property
     */
    static IProperty<Attachable, Boolean> ATTACHED = new Property_119<>("Attached", Attachable.class, Boolean.class, (attachable) -> {
     ...
     * Half property
     */
    static IProperty<Bisected, Bisected.Half> HALF = new Property_119<>("Half", Bisected.class, Bisected.Half.class, (bisected) -> {
     ...
     * Facing property
     */
    static IProperty<Directional, BlockFace> FACING = new Property_119<>("Facing", Directional.class, BlockFace.class, (directional) -> {
     ...
     * Level property
     */
    static IProperty<Levelled, Integer> LEVEL = new Property_119<>("Level", Levelled.class, Integer.class, (level) -> {
     ...
     * Lit property
     */
    static IProperty<Lightable, Boolean> LIT = new Property_119<>("Lit", Lightable.class, Boolean.class, (lit) -> {
     ...
     * Open property
     */
    static IProperty<Openable, Boolean> OPEN = new Property_119<>("Open", Openable.class, Boolean.class, (open) -> {
     ...
     * Axis property
     */
    static IProperty<Orientable, Axis> AXIS = new Property_119<>("Axis", Orientable.class, Axis.class, (axis) -> {
     ...
     * Powered property
     */
    static IProperty<Powerable, Boolean> POWERED = new Property_119<>("Powered", Powerable.class, Boolean.class, (powered) -> {
     ...
     * Rotation property
     */
    static IProperty<Rotatable, BlockFace> ROTATION = new Property_119<>("Rotation", Rotatable.class, BlockFace.class, (rotation) -> {
     ...
     * Snowy property
     */
    static IProperty<Snowable, Boolean> SNOWY = new Property_119<>("Snowy", Snowable.class, Boolean.class, (snowable) -> {
     ...
     */
    static IProperty<Waterlogged, Boolean> WATERLOGGED = new Property_119<>("Waterlogged", Waterlogged.class, Boolean.class, (waterlogged) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_EAST = new Property_119<>("East", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_NORTH = new Property_119<>("North", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_SOUTH = new Property_119<>("South", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<RedstoneWire, RedstoneWire.Connection> REDSTONE_WEST = new Property_119<>("West", RedstoneWire.class, RedstoneWire.Connection.class, (wire) -> {
     ...
     */
    static IProperty<DaylightDetector, Boolean> DETECTOR_INVERTED = new Property_119<>("Inverted", DaylightDetector.class, Boolean.class, (detector) -> {
     ...
     */
    static IProperty<Tripwire, Boolean> TRIPWIRE_DISARMED = new Property_119<>("Disarmed", Tripwire.class, Boolean.class, (tripwire) -> {
     ...
     * Hinge property. (Door)
     */
    static IProperty<Door, Door.Hinge> DOOR_HINGE = new Property_119<>("Hinge", Door.class, Door.Hinge.class, (door) -> {
     ...
     */
    static IProperty<Stairs, Stairs.Shape> STAIR_SHAPE = new Property_119<>("Shape", Stairs.class, Stairs.Shape.class, (stairs) -> {
     ...
     * Part property. (Bed)
     */
    static IProperty<Bed, Bed.Part> BED_PART = new Property_119<>("Part", Bed.class, Bed.Part.class, (bed) -> {
     ...
     * Type property. (Chest)
     */
    static IProperty<Chest, Chest.Type> CHEST_TYPE = new Property_119<>("Type", Chest.class, Chest.Type.class, (chest) -> {
     ...
     */
    static IProperty<CommandBlock, Boolean> COMMAND_CONDITIONAL = new Property_119<>("Conditional", CommandBlock.class, Boolean.class, (commandBlock) -> {
     ...
     */
    static IProperty<Comparator, Comparator.Mode> COMPARATOR_MODE = new Property_119<>("Mode", Comparator.class, Comparator.Mode.class, (comparator) -> {
     ...
     */
    static IProperty<Dispenser, Boolean> DISPENSER_TRIGGERED = new Property_119<>("Triggered", Dispenser.class, Boolean.class, (dispenser) -> {
     ...
     */
    static IProperty<EndPortalFrame, Boolean> END_PORTAL_EYE = new Property_119<>("Eye", EndPortalFrame.class, Boolean.class, (frame) -> {
     ...
     */
    static IProperty<Gate, Boolean> GATE_IN_WALL = new Property_119<>("In wall", Gate.class, Boolean.class, (gate) -> {
     ...
     */
    static IProperty<Hopper, Boolean> HOPPER_ENABLED = new Property_119<>("Enabled", Hopper.class, Boolean.class, (hopper) -> {
     ...
     */
    static IProperty<Piston, Boolean> PISTON_EXTENDED = new Property_119<>("Extended", Piston.class, Boolean.class, (piston) -> {
     ...
     */
    static IProperty<PistonHead, Boolean> PISTON_HEAD_SHORT = new Property_119<>("Short", PistonHead.class, Boolean.class, (pistonHead) -> {
     ...
     */
    static IProperty<Repeater, Integer> REPEATER_DELAY = new Property_119<>("Delay", Repeater.class, Integer.class, (repeater) -> {
     ...
     */
    static IProperty<Repeater, Boolean> REPEATER_LOCKED = new Property_119<>("Locked", Repeater.class, Boolean.class, (repeater) -> {
     ...
     */
    static IProperty<TechnicalPiston, TechnicalPiston.Type> TECHNICAL_PISTON_TYPE = new Property_119<>("Type", TechnicalPiston.class, TechnicalPiston.Type.class, (technicalPiston) -> {
     ...
     * North property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH = new Property_119<>("North", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * East property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST = new Property_119<>("East", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * South property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH = new Property_119<>("South", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * West property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST = new Property_119<>("West", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Up property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_UP = new Property_119<>("Up", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Down property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_DOWN = new Property_119<>("Down", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Northeast property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_EAST = new Property_119<>("Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Northwest property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_WEST = new Property_119<>("Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Southeast property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_EAST = new Property_119<>("Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Southwest property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_WEST = new Property_119<>("Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST_NORTH_WEST = new Property_119<>("West Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_NORTH_WEST = new Property_119<>("North Northwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_NORTH_NORTH_EAST = new Property_119<>("North Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST_NORTH_EAST = new Property_119<>("East Northeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_EAST_SOUTH_EAST = new Property_119<>("East Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_SOUTH_EAST = new Property_119<>("South Southeast", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SOUTH_SOUTH_WEST = new Property_119<>("South Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<MultipleFacing, Boolean> MULTI_WEST_SOUTH_WEST = new Property_119<>("West Southwest", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     * Self property.
     */
    static IProperty<MultipleFacing, Boolean> MULTI_SELF = new Property_119<>("Self", MultipleFacing.class, Boolean.class, (multipleFacing) -> {
     ...
     */
    static IProperty<NoteBlock, Instrument> NOTEBLOCK_INSTRUMENT = new Property_119<>("Instrument", NoteBlock.class, Instrument.class, (noteblock) -> {
     ...
     */
    static IProperty<NoteBlock, Note> NOTEBLOCK_NOTE = new Property_119<>("Note", NoteBlock.class, Note.class, (noteblock) -> {
     ...
     * Shape property. (Rail)
     */
    static IProperty<Rail, Rail.Shape> RAIL_SHAPE = new Property_119<>("Shape", Rail.class, Rail.Shape.class, (rail) -> {
     ...
     */
    static IProperty<SeaPickle, Integer> SEA_PICKLE_PICKLES = new Property_119<>("Pickles", SeaPickle.class, Integer.class, (pickle) -> {
     ...
     * Type property. (Slab)
     */
    static IProperty<Slab, Slab.Type> SLAB_TYPE = new Property_119<>("Type", Slab.class, Slab.Type.class, (slab) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_1 = new Property_119<>("Bottle 0", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_2 = new Property_119<>("Bottle 1", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BrewingStand, Boolean> BREWING_BOTTLE_3 = new Property_119<>("Bottle 2", BrewingStand.class, Boolean.class, (stand) -> {
     ...
     */
    static IProperty<BubbleColumn, Boolean> BUBBLE_COLUMN_DRAG = new Property_119<>("Drag", BubbleColumn.class, Boolean.class, (column) -> {
     ...
     * Bites property. (Cake)
     */
    static IProperty<Cake, Integer> CAKE_BITES = new Property_119<>("Bites", Cake.class, Integer.class, (cake) -> {
     ...
     */
    static IProperty<Farmland, Integer> FARMLAND_MOISTURE = new Property_119<>("Moisture", Farmland.class, Integer.class, (farmland) -> {
     ...
     */
    static IProperty<Leaves, Integer> LEAVES_DISTANCE = new Property_119<>("Distance", Leaves.class, Integer.class, (leaves) -> {
     ...
     */
    static IProperty<Leaves, Boolean> LEAVES_PERSISTENT = new Property_119<>("Persistent", Leaves.class, Boolean.class, (leaves) -> {
     ...
     */
    static IProperty<Sapling, Integer> SAPLING_STAGE = new Property_119<>("Stage", Sapling.class, Integer.class, (sapling) -> {
     ...
     */
    static IProperty<Snow, Integer> SNOW_LAYERS = new Property_119<>("Layers", Snow.class, Integer.class, (snow) -> {
     ...
     */
    static IProperty<StructureBlock, StructureBlock.Mode> STRUCTURE_BLOCK_MODE = new Property_119<>("Mode", StructureBlock.class, StructureBlock.Mode.class, (structureBlock) -> {
     ...
     */
    static IProperty<TNT, Boolean> TNT_UNSTABLE = new Property_119<>("Unstable", TNT.class, Boolean.class, (tnt) -> {
     ...
     */
    static IProperty<TurtleEgg, Integer> TURTLE_EGG_HATCH = new Property_119<>("Hatch", TurtleEgg.class, Integer.class, (egg) -> {
     ...
     */
    static IProperty<TurtleEgg, Integer> TURTLE_EGG_EGGS = new Property_119<>("Eggs", TurtleEgg.class, Integer.class, (egg) -> {
...
//    });
    ...
    static IProperty<Bamboo, Bamboo.Leaves> BAMBOO_LEAVES = new Property_119<>("Leaves", Bamboo.class, Bamboo.Leaves.class, (bamboo) -> {
    ...
    static IProperty<Bell, Bell.Attachment> BELL_ATTACHMENT = new Property_119<>("Attachment", Bell.class, Bell.Attachment.class, (bell) -> {
    ...
    static IProperty<Campfire, Boolean> CAMPFIRE_SIGNAL_FIRE = new Property_119<>("Signal Fire", Campfire.class, Boolean.class, (campfire) -> {
    ...
    static IProperty<Scaffolding, Boolean> SCAFFOLDING_IS_BOTTOM = new Property_119<>("Bottom", Scaffolding.class, Boolean.class, (scaffolding) -> {
    ...
    static IProperty<Scaffolding, Integer> SCAFFOLDING_DISTANCE = new Property_119<>("Distance", Scaffolding.class, Integer.class, (scaffolding) -> {
    ...
    static IProperty<Beehive, Integer> HONEY_LEVEL = new Property_119<>("Honey Level", Beehive.class, Integer.class, (beehive) -> {
    ...
    static IProperty<FaceAttachable, FaceAttachable.AttachedFace> FACE_ATTACHABLE = new Property_119<>("Face", FaceAttachable.class, FaceAttachable.AttachedFace.class, (attachable) -> {
    ...
    static IProperty<Jigsaw, Jigsaw.Orientation> JIGSAW = new Property_119<>("Orientation", Jigsaw.class, Jigsaw.Orientation.class, (jigsaw) -> {
    ...
    static IProperty<RespawnAnchor, Integer> RESPAWN_ANCHOR = new Property_119<>("Charges", RespawnAnchor.class, Integer.class, (anchor) -> {
    ...
    static IProperty<Wall, Wall.Height> WALL_HEIGHT_NORTH = new Property_119<>("North", Wall.class, Wall.Height.class, (wall) -> {
    ...
    static IProperty<Wall, Wall.Height> WALL_HEIGHT_SOUTH = new Property_119<>("South", Wall.class, Wall.Height.class, (wall) -> {
    ...
    static IProperty<Wall, Wall.Height> WALL_HEIGHT_EAST = new Property_119<>("East", Wall.class, Wall.Height.class, (wall) -> {
    ...
    static IProperty<Wall, Wall.Height> WALL_HEIGHT_WEST = new Property_119<>("West", Wall.class, Wall.Height.class, (wall) -> {
    ...
    static IProperty<Wall, Boolean> WALL_UP = new Property_119<>("Up", Wall.class, Boolean.class, (wall) -> {
    ...
    static IProperty<BigDripleaf, BigDripleaf.Tilt> DRIPLEAF_TILT = new Property_119<>("Tilt", BigDripleaf.class, BigDripleaf.Tilt.class, (leaf) -> {
    ...
    static IProperty<Candle, Integer> CANDLE_CANDLES = new Property_119<>("Candles", Candle.class, Integer.class, (candle) -> {
    ...
    static IProperty<CaveVinesPlant, Boolean> CAVE_VINE_BERRIES = new Property_119<>("Has Berries", CaveVinesPlant.class, Boolean.class, (vines) -> {
    ...
    static IProperty<PointedDripstone, BlockFace> DRIPSTONE_VERTICAL_DIRECTION = new Property_119<>("Vertical Direction", PointedDripstone.class, BlockFace.class, (dripstone) -> {
    ...
    static IProperty<PointedDripstone, PointedDripstone.Thickness> DRIPSTONE_THICKNESS = new Property_119<>("Thickness", PointedDripstone.class, PointedDripstone.Thickness.class, (dripstone) -> {
    ...
    static IProperty<SculkSensor, SculkSensor.Phase> SCULK_PHASE = new Property_119<>("Phase", SculkSensor.class, SculkSensor.Phase.class, (sensor) -> {
    ...
    static IProperty<Hangable, Boolean> HUNG = new Property_119<>("Hanging", Hangable.class, Boolean.class, (hung) -> {
    ...
    static IProperty<SculkCatalyst, Boolean> SCULK_CATALYST = new Property_119<>("Bloom", SculkCatalyst.class, Boolean.class, (sculk) -> {
    ...
    static IProperty<SculkShrieker, Boolean> SCULK_CAN_SUMMON = new Property_119<>("Can Summon", SculkShrieker.class, Boolean.class, (sculk) -> {
    ...
    static IProperty<SculkShrieker, Boolean> SCULK_SKEIEKING = new Property_119<>("Shrieking", SculkShrieker.class, Boolean.class, (sculk) -> {
    ...
    public static void registerProperties() {
        ...
        registered = true;
        for (Field field : Property_119.class.getDeclaredFields()) {
    ...
    private Property_119(String niceName, Class<D> dataType, Class<V> valueType, Function<D, D> next, Function<D, V> current, BiFunction<D, V, D> set) {
